package com.arioatlas.eshop.storage;
...
public class FileSystemStorageService implements StorageService {
    ...
    public String store(MultipartFile file, String path) {
        try {
            if (file.isEmpty()) {
                throw new StorageException("trying to save an empty file " + file.getOriginalFilename());
            }
            ...
            // for preventing from duplicated file name, the new file name is going to change to time + random number + file name
